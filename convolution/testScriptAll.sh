...
EXECUTABLE="run.sh"
TEST_DIRECTORY="tests/Experiments/convolutionExperimentsNativeEUROPAR/"
...
do
  ...
  do
    mkdir -p tests/Experiments/convolutionExperimentsNativeEUROPAR/spec${INPUT_SIZE}${TILE_SIZE}/
